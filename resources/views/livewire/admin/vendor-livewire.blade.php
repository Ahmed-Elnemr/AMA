                                        ...
                                        @if (isset($vendors) && count($vendors) > 0)
                                            @foreach ($vendors as $vendor)
                                                <tr>
                                                    <td>{{ $vendor->id }}</td>
                                                    <td>
                                                        <a href="{{ route('user-details', $vendor->id) }}">
                                                            <img alt="" class="rounded-circle avatar-md mr-2 "
                                                                src="{{ $vendor->profile_photo_path }}">
                                                        </a>

                                                    </td>
                                                    <td> <a href="{{ route('user-details', $vendor->id) }}"><span
                                                                class="tx-30">{{ $vendor->name }}</span></a> </td>
                                                    <td>
                                                        @if (isset($vendor->business->category->categories_title))
                                                        <span class="tx-20 text-center">{{ $vendor->business->category->categories_title }}</span>
                                                        @else
                                                    ...
                                                    <td>
                                                        @if (isset($vendor->business->legal_name ))
                                                        <span class="tx-20">{{ $vendor->business->legal_name }}</span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @if (empty($vendor->business->logoMedia->path))
                                                            Un selected Image
                                                        @else
                                                            <img src="{{ $vendor->business->logoMedia->path }}"
                                                                alt="no image" style="width: 100px ; height: 100px;">
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (empty($vendor->business->coverMedia->path))
                                                            Un selected Image
                                                        @else
                                                            <img src="{{ $vendor->business->coverMedia->path }}"
                                                                alt="no image" style="width: 100px ; height: 100px;">
                                                        @endif
                                                    </td>
                                                    <td>
